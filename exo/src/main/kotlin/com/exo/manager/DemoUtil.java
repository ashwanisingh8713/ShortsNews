...
public final class DemoUtil {
  ...
  public static synchronized <CronetEngine> DataSource.Factory getHttpDataSourceFactory(Context context) {
    if (httpDataSourceFactory == null) {
      if (USE_CRONET_FOR_NETWORKING) {
        context = context.getApplicationContext();
        @Nullable CronetEngine cronetEngine = (CronetEngine) CronetUtil.buildCronetEngine(context);
        if (cronetEngine != null) {
          httpDataSourceFactory =
              new CronetDataSource.Factory((org.chromium.net.CronetEngine) cronetEngine, Executors.newSingleThreadExecutor());
        }
      }
      if (httpDataSourceFactory == null) {
